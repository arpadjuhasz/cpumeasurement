...
{
    public class MeasurementListenerService : BackgroundService//IHostedService
    {
        ...
        public MeasurementListenerService(IConfiguration configuration, ILogger<MeasurementListenerService> logger)
        {
